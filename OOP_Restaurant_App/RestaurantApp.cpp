...
public:
	...
	Pizza(int tomato, int sausage, int cheese, double dough, int mushrooms, int pizzaSous, int et, int potatoes, int pepper, int salyami, string marqarita, string vegetarian, string ssalyami, string texas, string amerikano, string cpizza) {
		_tomato = tomato;
		_sausage = sausage;
		_cheese = cheese;
		_dough = dough;
...
public:
	...
	dolma() {
		...
		_EggPlantDolma = "Egg Plant Dolma";//badimcan
		_customDolma = "Custom Dolma";//badimcan
...
public:
	void menui() {
		...
		cout << "          Welcome to Majid's Restaurant!" << endl;
